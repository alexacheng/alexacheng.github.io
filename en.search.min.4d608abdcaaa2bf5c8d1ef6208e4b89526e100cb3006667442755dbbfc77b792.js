...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ace22bea0fb4a2463d28143731594ab8d12a08957ac750c86c0d6e37b56f79cf.js',function(){input.required=false;search();});}
